...
%%%% moving together in time as cooperation enducing mechanism. enhances rapport, and actually enhances the ability to persue joint goals (and those are three separate things that it does). therefore, should be measured.
...
%%% what's the scope of this project? What are we not doing? We're not doing much machine learning, we're just using nonlinear dynamical systems techniques
