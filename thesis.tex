...
There is more than one way to represent time series data, even given only the data itself and not any underlying function that generates it. The most important alternate representation is the frequency domain representation, which is taken in finite data with the Fourier transform.
...
An important precondition of much of the Fourier analysis viewpoint, %%% talk about continuity instead

%%% annoying bit about square integrability
