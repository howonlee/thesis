...
%%%% chart of not-smooth goes here

\subsection{Hilbert Transform and $\gamma$}

The Hilbert transform is a transform of real-valued time series data into data which "shows" its inherent phase. %%% look up the transform and redescribe again, I suppose
...
A deterministic transformation from time series to networks and from networks to time series can be made, however, if only a special kind of network called the \emph{labelled multigraph} is used. %%% mathematical definition, citation
