...
%%%% what is the fft, power spectrum, relation to autocorrelation
%%%% what is coherence
%%% other people have used spectral methods.
%%% why use coherence instead of other measures? strengths, weaknesses

%%% overall graphs, examples, mc graphs
...
\begin{figure}\label{fig:stack_ts_degree}
  \begin{center}
    \includegraphics[scale=0.6]{degrees_sinusoid}
    \includegraphics[scale=0.6]{degrees_logistic}
    \includegraphics[scale=0.6]{degrees_fbm}
    \includegraphics[scale=0.6]{degrees_vr}
  \end{center}
