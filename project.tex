...
%%% two theories, discrete and continuous, information processing and dynamical systems
%%% both unified in the modelling of error dynamics by pressing 1999
%%% we don't have a model of error correction, we have the synchronization measurement itself. go over the models existing super quick. parametric linear models, with corrections for observed nonlinearities.
%%% cool kids overfitting arguments for the nonlinearities
...
%%%%% talk about nice devolution of linearity
