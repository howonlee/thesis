...
--- there's a big other physiological data literature: eeg, ekg. talk about why it doesn't apply directly to us, though there is a social synchronization citation
...
We will claim that relations of this sort are common in physiological data of all kinds. %%%% recapitulate those arguments from physiological data
