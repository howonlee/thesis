...
%% describe what a poincare plot is. describe our poincare plot summary measure, and put the summary in
...
%%% table of poincare plots goes here
...
$s_H$ is called the Hilbert transform; $PV$ indicates that the integral is a Cauchy principal value integral. The Hilbert transform is thus formally equivalent to convolution of $s(t)$ with $\frac{1}{\pi t}$, so in practice, it can easily be calculated from the fast Fourier transform.
