...
%%% ami and cmi stand for auto and cross mutual information, respectively.
%%% why are they important? better analogy to auto and cross correlation measures, basically
...
%%% why is it a _transform_? (aka, show that math). what is power spectrum? what is the relation to the autocorrelation?

%%% other people have used spectral methods.

\subsection{Gibbs Phenomenon}

An important precondition of much of the Fourier analysis viewpoint is the continuity of the functions which are to be transformed. %%% talk about continuity instead

%%% annoying bit about square integrability and lipschitz function. we have finite data. but talk about the Gibbs phenomenon anyways

\subsection{Analytic Functions, Hilbert Transform and $\gamma$}

%%%Why do we need the Hilbert transform? When can we use it? Give the data that shows that we can use it.
...
A deterministic transformation from time series to networks and from networks to time series can be made, however, if only a special kind of network called the \emph{labelled multigraph} is used. %%% mathematical definition, cite would be nice

%%% talk about 1/f noise

%%% prove that this transformation works on square waves and on nonsmooth functions
