...
We can take the problem at hand as trying to find hidden structure in the unlabelled time series we are given, where the hidden structure is any present synchrony. Therefore, this is an unsupervised learning problem. %%%% why?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% picture of stack graph creation process

%%%% turn these into proper figures
\begin{verbatim}
